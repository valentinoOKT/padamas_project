...
<ol class="carousel-indicators">
    ...
    <div class="carousel-inner">
        <div class="item active">
            <img src="<?php echo base_url('assets/upload/image/'.$stock->gambar) ?>" alt="<?php echo $stock->judul_galeri ?>">
        </div><!-- End .item -->
    ...
    <div class="portfolio-related-carousel owl-carousel popup-gallery">
        ...
        <div class="portfolio-item portfolio-image-zoom portfolio-meta-slideup">
            ...
            <div class="portfolio-meta dark">
                <h3 class="portfolio-title"><a href="<?php echo base_url('stock/read/'.$listing->id_galeri) ?>"><?php echo $listing->judul_galeri ?></a></h3>
                <div class="portfolio-tags"><a href="<?php echo base_url('stock/kategori/'.$listing->slug_kategori_galeri) ?>"><?php echo $listing->nama_kategori_galeri ?></a></div>
