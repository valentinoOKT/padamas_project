...
<div class="row">
  ...
  <div class="col-md-9 col-sm-8 col-xs-12 block">
    <div class="thumbnail thumbnailContent">
      <img src="<?php echo base_url('assets/upload/image/'.$layanan->gambar) ?>" alt="image" class="img-responsive">
      <div class="sticker-round bg-color-1"><?php echo date('d',strtotime($layanan->tanggal)) ?> <br><?php echo date('M',strtotime($layanan->tanggal)) ?></div>
      <div class="caption border-color-1 singleBlog">
        <h3 class="color-1"><?php echo $title ?></h3>
        <ul class="list-inline blogInfo">
          <li><i class="fa fa-user" aria-hidden="true"></i><?php echo $layanan->nama ?></li>
          <li><i class="fa fa-tags" aria-hidden="true"></i><?php echo $layanan->nama_kategori ?></li>
        </ul>
