                    ...
                    <div class="blog-style-2">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="blog-items">
                                    <div class="blog-img" style="width:770px;height:370px;">
                                        <a href="<?php echo base_url('layanan/read/' . $layanan->slug_layanan); ?>"><img src="<?php echo base_url('assets/upload/image/'.$layanan->gambar) ?>" alt="blog-img-10" class="img-responsive" /></a>
                                    </div>
                                    <!-- .blog-img -->
                                    <div class="blog-content-box">
                                        <div class="blog-content">
                                            <h4><a href="<?php echo base_url('layanan/read/' . $layanan->slug_layanan); ?>"><?php echo $layanan->judul_layanan; ?></a></h4>
                                            <ul class="meta-post">
                                                <li><i class="fa fa-calendar" aria-hidden="true"></i> <?php echo date('d M Y', strtotime($layanan->tanggal_publish)); ?></li>
                                                <li><i class="fa fa-user"></i> <?php echo $layanan->nama; ?></li>
                                                <!-- <li><a href="#"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $layanan->hits; ?> Viewer</a></li> -->
                                            </ul>
                                            <p class="text-justify"><?php echo character_limiter(strip_tags($layanan->isi), 200); ?></p>
                                            <a href="<?php echo base_url('layanan/read/' . $layanan->slug_layanan); ?>"><i class="fa fa-chevron-right"></i> Selengkapnya</a>
                                        </div>
                                        <!-- .blog-content -->
                                    </div>
                                    <!-- .blog-content-box -->
                            ...
                            <div class="col-md-4">
                                <div class="sidebar">
                                    <div class="widget">
                                        <h4 class="sidebar-widget-title">Layanan Terpopuler</h4>
                                                ...
                                                <?php foreach($populer as $populer) { ?>
                                                    <li>
                                                        ...
                                                        <div class="popular-news-contant">
                                                            <h5><a href="<?php echo base_url('layanan/read/' . $populer->slug_layanan); ?>"><?php echo $populer->judul_layanan; ?></a></h5>
                                                            <p>
