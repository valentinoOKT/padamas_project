<?php if($sold->popup_status == "Publish") { ?>
...
<div class="modal-footer">
    ...
    <?php if($sold->popup_status == "Publish") { ?>
		<a href="<?php echo base_url('admin/popup/non_aktifkan/'.$sold->id_galeri) ?>" class="btn btn-success">
    <i class="fa fa-check"></i> Ya, Non Aktifkan</a>
    <?php }else{ ?>
    	<a href="<?php echo base_url('admin/popup/aktifkan/'.$sold->id_galeri) ?>" class="btn btn-success">
