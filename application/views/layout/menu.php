        ...
        <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <li class="sub-active"><a href="<?php echo base_url('layanan/rental/'.$nav_layanan->slug_layanan) ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> <?php echo $nav_layanan->judul_layanan ?></a></li>
                    <?php } ?> 
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu sub-menu">
                    ...
                    <li class="sub-active"><a href="<?php echo base_url('layanan/service/'.$nav_topik->slug_layanan) ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> <?php echo $nav_topik->judul_layanan ?></a></li>
                    <?php } ?> 
                </ul>
            </li>
